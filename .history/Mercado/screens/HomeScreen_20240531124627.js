    ...
    <Animatable.View animation="bounceIn" style={[styles.container, { opacity: fadeAnim }]}>
      ...
      <Animatable.View animation="bounceIn" style={styles.inputContainer}>
        ...
        <View style={styles.buttonRow}>
          <TouchableOpacity style={styles.button3} onPress={clearList}>
            <Text style={styles.buttonText3}>Limpar Lista</Text>
          </TouchableOpacity><TouchableOpacity style={styles.button} onPress={addProduct}>
